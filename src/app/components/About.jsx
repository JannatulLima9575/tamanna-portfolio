export default function About() {
  return (
    <section
      id="about"
      className="min-h-screen flex flex-col md:flex-row justify-center items-center gap-12 bg-[#d5fdf9] px-6 md:px-16 py-20"
    >
      {/* Image Left */}
      <div
        className="w-72 md:w-96 rounded-xl border-4 border-[#007F73] overflow-hidden
        shadow-[0_0_25px_rgba(0,127,115,0.6)] transition duration-500 hover:shadow-[0_0_35px_rgba(0,127,115,0.8)]"
      >
        <img
      ...
      <div className="max-w-xl text-center md:text-left">
        ...
        <h3 className="text-3xl mt-4 font-semibold text-gray-700">
        ...
        <a
          href="#"
          className="inline-block mt-6 bg-[#007F73] text-white py-3 px-6 rounded-full font-semibold hover:shadow-lg transition"
        >
          Read more
        </a>
      </div>
